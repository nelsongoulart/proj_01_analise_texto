...
```{r}
visualizeWordcloud <- function(term, freq, title = "", min.freq = 50, max.words = 100){
...
# Explorando a frequência absoluta e frequência relativa de palavras título-a-título 1
...
# Explorando a frequência absoluta e frequência relativa de palavras título-a-título 2
